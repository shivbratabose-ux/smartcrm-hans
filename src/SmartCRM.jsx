      ...
      <div className="app">
        ...
        <div className="main">
          ...
          <div className="content" id="main-content" role="main">
            ...
            {page==="leads"      && <Leads leads={leads} setLeads={setLeads} accounts={accounts} contacts={contacts} currentUser={currentUser} onConvertToOpp={convertLeadToOpp} orgUsers={orgUsers} activities={activities} setActivities={setActivities} callReports={callReports} setCallReports={setCallReports}/>}
