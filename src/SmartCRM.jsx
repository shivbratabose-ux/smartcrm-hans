      ...
      <div className="app">
        ...
        <div className="main">
          ...
          <div className="content" id="main-content" role="main">
            ...
            {page==="contacts"   && <Contacts contacts={visibleContacts} setContacts={setContacts} onDeleteContact={cascadeDeleteContact} accounts={visibleAccounts} opps={visibleOpps} activities={visibleActivities} canDelete={canDelete} currentUser={currentUser}/>}
