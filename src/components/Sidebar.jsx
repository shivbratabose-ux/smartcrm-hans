...
import {
  ...
  UserPlus, Phone, FileText, DollarSign, Target, Calendar, ClipboardList, Mail, Upload, Bell, HelpCircle, Trash2, Briefcase, Gauge, Sparkles, UserCheck, Inbox
} from "lucide-react";
...
function Sidebar({page,setPage,collapsed,setCollapsed,tickets,leads,collections,currentUser,onLogout,orgUsers,customPermissions,myUnreadCount,canRestore}) {
  ...
  const NAV=[
    ...
    {section:"Analytics",items:[
      ...
      {id:"emailagent",label:"Email Agent",icon:<Inbox size={17}/>},
    ]},
    {section:"Admin",items:[
