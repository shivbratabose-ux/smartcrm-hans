...
export const ROLES_HIERARCHY = [
  ...
  {id:"finance",     name:"Finance",           level:4, color:"#0891B2", desc:"Approves new accounts & issues account numbers; manages collections, billing & contracts"},
  {id:"product_head",name:"Head GM – Product Delivery & Success", level:3, color:"#EA580C", desc:"Owns customer experience, onboarding/implementation & delivery for one or more products (set as the product's Line Manager in Masters → Catalog). Manages all issues, requirements & enhancements for those products routed from support & sales."},
...
export const PERMISSIONS = {
  ...
  finance:     {accounts:"rw",contacts:"r", pipeline:"r", activities:"r", tickets:"r", reports:true,masters:false,org:"r", team:"r"},
  product_head:{accounts:"rw",contacts:"rw",pipeline:"r", activities:"rw",tickets:"rw",reports:true,masters:"r", org:"r", team:"r"},
...
// ── Bulk Upload Types ──
export const UPLOAD_TYPES = ["Leads","Customers","Contacts","Collections","Support Tickets","Contracts","Invoices","Pipeline","Call Reports"];
...
export const PERMISSIONS_EXT = {
  ...
  finance:     {leads:"r", callReports:"r", contracts:"rw",collections:"rw",targets:"r"},
  product_head:{leads:"r", callReports:"rw",contracts:"rw",collections:"r", targets:"r"},
